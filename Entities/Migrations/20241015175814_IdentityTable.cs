    ...
    public partial class IdentityTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Amazing movie! A must-watch for sci-fi fans.", new DateTime(2024, 10, 15, 20, 58, 12, 846, DateTimeKind.Local).AddTicks(9449), 1, 5f, "testuser1" },
                    { 2, "An iconic masterpiece of cinema.", new DateTime(2024, 10, 15, 20, 58, 12, 846, DateTimeKind.Local).AddTicks(9458), 2, 5f, "testuser2" }
                });
